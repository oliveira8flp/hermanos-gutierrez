    ...
    return (
        <section className="Banner2 flex-wrap flex relative bg-[#F5EBD0] w-[100vw] h-[120vh] pt-48">
            ...
            <div className="flex flex-col banner2right w-[49%] h-[100%] items-end gap-2">
                <Hero text_size = "text-[14rem]" text_sizeMobile="text-[2rem]" dropShadow="drop-shadow-[-4px_6px_0px_rgba(218,78,43,1)]" text="On Our Way" width="w-[60vw]" color="text-black" text_align="text-right"/>
