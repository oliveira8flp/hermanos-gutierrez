...
const OurSocials = () => {
    return (
        <section className="Banner6 flex-wrap flex-row flex relative justify-end items-center bg-[#F5EBD0] w-full h-[90vh] pt-32">
            <div className="banner6 flex justify-center items-center w-full h-[30vh]">
                <Hero dropShadow="drop-shadow-[-4px_6px_0px_rgba(73,130,157,1)]" text="Our Socials" color="" width="w-[95%]" text_align="text-center" />
            </div>
