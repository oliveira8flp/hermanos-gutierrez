    ...
    return (
        <section className ="Banner5 flex-wrap flex items-center justify-center relative bg-[#F5EBD0] w-full h-[140vh] pb-92">
            <div className = "flex justify-end w-full h-[50vh] items-end ">
                <Hero height="h-[60vh]" text_size = "text-[10rem]" text_sizeMobile="text-[2rem]" dropShadow="drop-shadow-[-4px_6px_0px_rgba(138,157,73,1)]" text="In the Midia" color="text-black" width="w-[80%]" text_align="text-right" />
            </div>
