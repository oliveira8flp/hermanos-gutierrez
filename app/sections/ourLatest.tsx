...
const OurLatest = () => {
    return (
        <section className ="Banner4 flex-wrap flex-row flex relative bg-[#F5EBD0] w-[100vw] h-[100vh]">
            <div className="banner4Left w-[48%] h-[70vh] flex flex-col justify-center items-start">
                <Hero dropShadow="drop-shadow-[-4px_6px_0px_rgba(100,146,136,1)]" text="Our Latest" width="w-[60vw]" color = "text-black"/>
            ...
            <div className = "gap-2 banner4Right w-[48%] h-[90vh] flex flex-col justify-center items-end">
                ...
                <Button text="listen on spotify" color="bg-[#649288]" textColor="text-white" />
                <Button text="listen on youtube" color="bg-black" textColor="text-white" />
            </div>
